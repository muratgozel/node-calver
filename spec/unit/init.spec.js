describe('init', function() {
  it('creates initial calver versions', function() {
    ...
    expect(calver.init('major.minor.micro.dev')).toBe('1.0.0-dev.1')
    expect(calver.init('yy.mm.minor.micro.alpha')).toBe('21.1.0.0-alpha.1')
    expect(calver.init('yy.mm.minor.micro.modifier')).toBe('21.1.0.0')
  })
})
